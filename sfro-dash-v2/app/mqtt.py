...
class TempestMqttPublisher:
    ...
    def _on_connect(self, client, userdata, flags, rc, properties=None):
        # rc is connection result in v1.x; in v2.x rc is ReasonCode object
    ...
    def publish(self, data):
        ...
        try:
            # Publish only the processed section of the data to keep payloads clean,
            # or the entire packet if desired. Let's publish the structured data, 
            # including processed observations and roof status.
            payload = {
